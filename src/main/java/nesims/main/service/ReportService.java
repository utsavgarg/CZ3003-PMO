...
public class ReportService implements ReportRepository{
    ...
    private static List<Report> populateDummyReports(){
        ...
        reports.add(new Report(counter.incrementAndGet(), "Kevin", "General" , 5, "Rougue A.I", "Area4", 10000, "1 HR", "It follows warnings that scientists have successfully trained computers to use artificial intelligence to learn from experience – and one day they could be smarter than their creators.\r\n" + 
        		...
        		"\r\n" + 
        		"They've been relatively unsophisticated until now - repeating back a set script dependant on what you type into their chatboxes.", "To do this effectively, the super-smart software realised it would be more effective to write and use their own language - which is completely incomprehensible to humans.\r\n" + 
        				"\r\n" + 
        				"In a blogpost, the Facebook researchers wrote: \"To date, existing work on chatbots has led to systems that can hold short conversations and perform simple tasks such as booking a restaurant.", "One of the world's smartest men, Professor Stephen Hawking has also warned that super-smart software will spell the end of our species.", "He's claimed that we must leave planet Earth within 100 years - or face extinction as machines rise up and overtake us in the evolutionary race."));
        return reports;
    }
