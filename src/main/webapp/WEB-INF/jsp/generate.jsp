			...
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion"
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="PMO Chat" id="chat"><a class="nav-link" href="/chat">
						<i class="fa fa-fw fa-edit"></i> <span class="nav-link-text" style="font-size: 0.8rem;">PMO
							Chat</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Generate Report" id="report"
					style="background: rgba(255, 255, 255, .05);"><a
					class="nav-link" href="/generate"> <i
						class="fa fa-fw fa-file-pdf-o"></i> <span class="nav-link-text" style="font-size: 0.8rem;">Generate
							Report</span>
				</a></li>
			</ul>
