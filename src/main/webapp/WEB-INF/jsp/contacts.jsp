	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top"
		...
		<div class="collapse navbar-collapse" id="navbarResponsive">
			<ul class="navbar-nav navbar-sidenav" id="exampleAccordion"
				...
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Dashboard1" id="dash"><a class="nav-link"
					href="/dashboard"> <i class="fa fa-fw fa-dashboard"></i> <span
						class="nav-link-text" style="font-size: 0.8rem;">Dashboard</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="PMO Chat" id="chat"><a class="nav-link" href="/chat">
						<i class="fa fa-fw fa-edit"></i> <span
						class="nav-link-text" style="font-size: 0.8rem;">PMO Chat</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
					title="Contacts" id="contact"
					style="background: rgba(255, 255, 255, .05);"><a
					class="nav-link" href="/contacts"> <i
						class="fa fa-fw fa-address-book"></i> <span class="nav-link-text"
						style="font-size: 0.8rem;">Contacts</span>
				</a></li>
				<li class="nav-item" data-toggle="tooltip" data-placement="right"
			...
			<ul class="navbar-nav ml-auto">
				<li class="nav-item"><a class="nav-link" data-toggle="modal"
					data-target="#logoutModal" style="color: black;"> <i
						class="fa fa-fw fa-sign-out"></i>Logout <b id="valueHolderId">
